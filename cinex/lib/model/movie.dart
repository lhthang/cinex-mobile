import 'package:cinex/model/genre.dart';
import 'package:cinex/model/rate.dart';
...
class Movie {
  ...
  factory Movie.fromJson(Map<String, dynamic> json) {
    ...
    List<ScreenType> screenTypesList = list.map((screenType) =>
        ScreenType.fromJson(screenType)).toList();
